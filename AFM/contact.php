...
<div id="divBoxed" class="container">
    ...
    <div id="navbar" class="divPanel notop nobottom">
            <div class="row-fluid">
                <div class="span12">

                    <div id="divLogo" class="pull-left">
					    <a class="navbar-brand" href="index.html"><img src="images/logo.png"  class = "img-responsive img-thumbnail" alt="logo"></a>
                       <a href="index.html" id="divSiteTitle"><strong>AFM</strong></a><br />
                        <a href="index.html" id="divTagLine"><strong>House of Prayer</strong></a>
                    </div>
    ...
    <div id="divFooter" class="footerArea">
        ...
        <div class="divPanel">
            <div class="row-fluid">
                <div class="span12">
                    <p class="copyright">
                        Copyright © 2016 House of Prayer AFM. All Rights Reserved.
                    </p>

                    <center><p class="social_bookmarks">
