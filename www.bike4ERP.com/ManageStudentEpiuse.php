	...
	session_start();
			...
			if(isset($_POST["updateSchool"]))
			{
				if(isset($_POST["checkSch"]))
				{
					...
					$sql =  "SELECT * FROM tblschool WHERE schoolid = '$id'";
					...
					if(isset($check))
					{
						...
						if ($result->num_rows > 0)
						{
							if($row = $result->fetch_assoc()) 
							{
								...
								header("Location:UpdateSchool.php");
							}
						}
					}
				...
				{
					$_SESSION["message"] = "Please select one school to update ";
				}
				
			
			 }
			 
			 else if (isset($_POST['ViewStud']))
			{
				  	if(isset($_POST["checkSch"]))
					{
						...
						$sql =  "SELECT * FROM tblstudent WHERE schoolid = '$id'";
						$check = mysqli_fetch_array(mysqli_query($con,$sql));
						...
						if(isset($check))
						{
							...
							if ($result->num_rows > 0)
							{
								if($row = $result->fetch_assoc()) 
								{
									...
									$_SESSION["previous"]=$row['previousMarks'];
								...
								{
								  $_SESSION["message"] = "No students available in the selected school";
								}
						}
				...
				<div class="col-lg-12">
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<span style="color:blue;text-align:center;"> <?php echo $_SESSION["message"]?></span>
								<div class="col-lg-12">
									<div class="panel panel-default">
										<div class="panel-heading">
											...
											<div class="panel-body">
											<form action="ManageStudentEpiuse.php" method="POST">
												...
												$results = $conn->query("select schoolname,schoolid from tblschool");
												 ...
												 while ($row=$results->fetch_assoc())
													{
														...
														echo "<td><input type='radio' name='checkSch' value='$id' ></td>";
														echo "<td align='justify'>".$name."</td>";
													...
													<span>
								<button class="btn btn-info" name="updateSchool">Update</button>
								<button class='btn btn-info' name='ViewStud'>View</button>
								<button class="btn btn-info" name="register" href="Registration.html" type="submit">Deactivate</button>
