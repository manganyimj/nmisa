													...
													<table class="table table-striped table-bordered table-hover" id="dataTables-example">
														...
														<tbody>		
															<tr class="gradeA">
																...
																<td>
																	<input type="text" value="48%" name="marks" id="marks" onkeyup="validateMarks()" required="required"  class="form-control">
																</td>
															</tr>
															<tr class="gradeA">
																<td>Maifo</td>
																...
																<td>
																	<input type="text" value="35%" name="marks" id="marks" onkeyup="validateMarks()" required="required"  class="form-control">
																</td>
															</tr>
														</tbody>
													</table>
