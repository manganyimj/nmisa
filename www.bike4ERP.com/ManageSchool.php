...
<body>
    ...
    <div id="wrapper">
      ...
      <ul class="nav" id="side-menu">
					...
					<li >
                        <a href="Epiuse.html"><i class="fa fa-dashboard fa-fw"></i><b>Add/Manage users</b><span class="fa arrow"></span></a>
					...
					<li >
                        <a href="Epiuse.html"><i class="fa fa-dashboard fa-fw"></i><b>Manage schools/students</b><span class="fa arrow"></span></a>
						 <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="ManageStudentEpiuse.html">Manage students</a>
                            </li>
													...
													<table class="table table-striped table-bordered table-hover" id="dataTables-example">
														...
														<tbody>		
															<tr class="gradeA">
																...
																<td class="center"><a href="StudentList.html">View</a><a href="StudentList.html">Edit</a></td>
