		...
		{*/
			...
			if(isset($_POST["update"]))
			{
				if(isset($_POST["check"]))
				{
					...
					$sql =  "SELECT * FROM tblusers WHERE idno = '$id'";
				...
				{
					$_SESSION["message"] = "Please select one user ";
				}
				...
				<div class="col-lg-12">
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<div class="col-lg-12">
									<div class="panel panel-default">
											...
											<form action="ManageUsers.php" method="POST">
												...
												$results = $conn->query("select idno,name,surname,cellNO,email,role from tblusers");
								...
								<button class="btn btn-info" name="register" href="Registration.html" type="submit">Delete</button>
								</span>
							</div>
							</form>
												</div>
