		...
		{*/
			...
			if(isset($_POST["updateStudent"]))
			{
				if(isset($_POST["checkStud"]))
				{
					...
					$sql =  "SELECT idno,schoolid,bikeNO,name,surname,distance,grade,previousMarks FROM tblstudent WHERE idno = '$id'";
					...
					if(isset($check))
					{
						...
						if ($result->num_rows > 0)
						{
							if($row = $result->fetch_assoc()) 
							{
								...
								header("Location:updateStudentEpiuse.php");
							}
						}
					}
				...
				{
					$_SESSION["message"] = "Please select one student ";
				}
...
<head>
    ...
    <title>Bikes4ERP Attendance</title>
							...
							<div class="panel-body">
								<div class="col-lg-12">
									<div class="panel panel-default">
											...
											<div class="panel-body">
											<form action="StudentListEpiuse.php" method="POST">
												...
												$results = $conn->query("select idno,name,surname,bikeNO,distance,grade,previousMarks from tblStudent");
												 ...
												 while ($row=$results->fetch_assoc())
													{
														...
														$previous=$row['previousMarks'];
														
														echo "<tr class='gradeA'>";
														echo "<td><input type='radio' name='checkStud' value=$id></td>";
														echo "<td>".$name."</td>";
														echo "<td>".$surname."</td>";
														echo "<td>".$id."</td>";
														echo "<td>".$grade."</td>";
													...
													<span>
								<button class="btn btn-info" name="updateStudent">Update</button>
								<button class="btn btn-info" name="register" href="Registration.html" type="submit">Deactivate Student</button>
								</span>
							</div>
							</form>
												</div>
