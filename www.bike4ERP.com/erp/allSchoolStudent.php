<?php
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		{
			$sql = "Select tblStudent.idno as id, tblStudent.bikeNO as bike from tblStudent, tblSchool where tblSchool.schoolid = tblStudent.schoolid AND tblSchool.adminid ='$adminID'";
