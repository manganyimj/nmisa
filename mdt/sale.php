	     ...
	     <div class="panel panel-primary" style="box-shadow: 2px 2px 2px 2px #1b374f;">
            ...
            <div class="col-md-2 col-md-offset-0" id="adside">
                ...
                <div class="list-group">
                    <a href="giyani.php" class="list-group-item">Giyani</a>
                    <a href="mal.php" class="list-group-item">Malamulele</a>
                    <a href="Tzan.php" class="list-group-item">Tzaneen</a>
					<a href="Toy.php" class="list-group-item">Thohoyandou</a>
					<a href="elim.php" class="list-group-item">Elim</a>
                </div>
            ...
            <div class="col-md-8">
					...
					<img class="img-responsive" src="images/brouchers/adhere.png"  height="600" width="950" alt="Manganyi Image" id="social"  onclick="clearInterval(timer);"> 
			 ...
			 function change(){
				...
				if(prof_pic == 'm'){
				   ...
				   prof_pic = 'v';
				    ...
				    {
					   image.src = 'images/brouchers/adhere.png';
					   prof_pic = 'j';
					}else if(prof_pic == 'j')
					     {
						      image.src = 'images/events/event.png';
