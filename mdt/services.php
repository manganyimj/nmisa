            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <span class="fa-stack fa-4x">
                        ...
                        <i id="iconani"class="fa fa-laptop fa-stack-1x fa-inverse"></i>
                    </span>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading myFont" style="text-shadow: 1px 1px 2px blue;">Posters Design</h4>
                    <p>We design posters for any event you can think of, trust us with your event poster. We will do it for you <p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <div class="col-md-4">
                <div class="panel panel-primary text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <span class="price"><sup>R</sup>25</span>
                        <span style="color:red" class="period">per month.</span></br> 
						<span style="color:red" class="period">OR</span> 
						</br>
						<span  class="price"><sup>R</sup>300</span>
                        <span style="color:red" class="period">annually.</span>
                    </div>
                    <ul class="list-group">
					  
                        <li class="list-group-item"> 500 MB Disk space</li>
                        <li class="list-group-item"><strong>1</strong> UNLIMITED* Traffic</li>
                        <li class="list-group-item"><strong>Unlimited</strong> Email Accounts</li>
                        <li class="list-group-item"><strong>Host 1 Domain</li>
						<li class="list-group-item"><strong>1 Database</li>
						<li class="list-group-item"><strong>cPanel (Control Panel)</li>
                        <li class="list-group-item">WordPress, Joomla, Drupal</li>
                        </li>
                    </ul>
                </div>
            </div>
