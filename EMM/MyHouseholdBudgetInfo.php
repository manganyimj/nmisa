...
if(!isset($check))
{
     $_SESSION["updateMssg"]="No household budget information found for you";
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
        if(isset($_POST["btnUpdate"]))
        {
            ...
            {
                $_SESSION["budgetMssg2"]="please Select Row to update..!!";
                    ...
                    <div class="panel panel-info">
                         <center>
                              <?php
                                ...
                                if(isset($_SESSION["budgetMssg2"]))
                                {
                                    echo "<center><P style=color:orange>".$_SESSION["budgetMssg2"]."</p></center>";
                                }
