	...
	<section id="register">
        <div class="container">
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">HELP Information</h4></div>
			  <div class="panel-body">
				
                              
                                  
                                  <p><b><u>How to register ?</u></b></p>
                                  <p>* Click register link</p>
                                  <p>* Then provide your ID number and login details</p>
                                  <p>* Note valid details are required</p>
                                  <p>* After successfully providing all the required data you will be directed to login page </p>
                                  <p>* provide your login details (Username: your email address)</p>
                                  <p>* Note: If you provide incorrect password 3 times the system will block you username</p>
                                  <p>* After login you will be directed to applicant home page, click apply link and provide all the required data</p>
                                  <p>* Insure that you have all supporting documents  and your household member(s) info ready</p>
                                  <p>* Note the system will display error messages in case invalid details are provided</p>
                                  <p><b><u>Blocked User</u></b></p>
                                  <p>*Note: If your username is blocked, contact our administrator at admin@emm.co.za or wait for 24 hours to be unblocked </p>
                          </div>
			</div>
			</div>
			</article>
