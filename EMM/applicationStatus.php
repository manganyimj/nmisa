...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if(isset($_POST["btnSubmit"]))
	{
            ...
            else
            {
                ...
                $login=new Login($_POST['id'], $_POST['username'], $_POST['password'], 'Applicant', 'Active');
                $databaseManager=new DatabaseManager();
                $databaseManager->addLogin($login);
                $_SESSION['login'] = serialize($login);
	...
	<section id="register">
        ...
        <div class="container">
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">Application Status</h4></div>
			  <div class="panel-body">
                            ...
                            $sql= "SELECT * FROM tblapplicationstatus Where applicantID=$id";
                            ...
                            if($StatusFound)
                            {
                                if($status=="A")
                                {
                                    echo "<center><P style=color:orange>Congratulations....!!! Your application is successful, you qualifies for electricity and water tax discount of 50% </p></center>";
                                }
                                else if($status=="D")
                                {
                                    echo "<center><P style=color:orange>We are sorry to let you know that your applcation is unsuccessful. The reason has been provided under Acknolegement AND Messages link</p></center>";
                                }
                                else
                                {
                                    echo "<center><P style=color:orange>Your application is still in progress. Note that an email will also be sent to you regarding your application status</p></center>";
                                }
                            }
                            else
                            {
                                 echo "<center><P style=color:orange>No status found for you because you did not send any application. Please apply first so then you can check your status</p></center>";
			   ...
			   ?>
                          ...
                          <center>
                           ...
                           <li class="btn btn-link">
                                    <a class="btn-link" href="ApplicantLogin.php">Main Page</a>
                           </li>
