...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if(isset($_POST["btnSearch"]))
	{
            ...
            require_once './PHP/dbConnect.php';;
            $accNum=$_POST["accNum"];
            $sql= "SELECT * FROM tblaccount where id='$accNum' OR reffNum='$accNum'";
            ...
            {
               $_SESSION["signInMssg"]="No applicant details found for account/ref number :".$accNum." Please provide registered account/ref number"; 
               header('location:feedBack.php');
            }
           
           
	}
        else if(isset($_POST["btnAddressDirection"]))
	{
             //==================================================================
            require_once './PHP/dbConnect.php';;
            $accNum=$_POST["accNum"];
            ...
            if(isset($check))
            {
                ...
                if ($result->num_rows > 0)
                {
                    ...
                    $_SESSION["viewId"]=$userId;
                    header('location:AddressAndContact.php');
                }
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-heading" > <h4 class="thin text-center">Search</h4></div>
                          <div class="panel-body">
                              ...
                              <input type="search" class="form-control" id="accNum" name="accNum" onkeyup="validateSearch()" required placeholder="Enter ID number or Ref number" >
                              <br>
                              <center>
                              <table>
                                <tr>
					...
					<center><button type="submit" name="btnSearch"  id="btnSearch" >View Applicant details</button></center>
                                  ...
                                  <td>
					<center><button type="submit" name="btnAddressDirection"  id="btnAddressDirection" >View Address</button></center>
				  </td>
                                </tr>
                              </table>
                             </center>   
                            ...
                            <li class="btn btn-link">
                                <a class="btn-link" href="ViewAllApplicantsToVerify.php"> View All applicants</a>
                            </li>
                             </ul>
