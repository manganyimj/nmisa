...
<form name="form3" action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="POST" onsubmit="return validateForm()">
	<section id="register">
        <div class="container">
			...
			<center>
				<button type="submit" name="btnIndApplication" id="btnIndApplication" class="btn btn-success">Indigent Application</button>
				<button type="submit" name="btnHouseMember" id="btnHouseMember" class="btn btn-success">Household Members</button>
				<button type="submit" name="btnHouseBudget" id="btnHouseBudget" class="btn btn-info">Household Budget</button>
				<button type="submit" name="livingCond" id="livingCond" class="btn btn-warning">Living Condition</button>
				<button type="submit" name="btnSupportingDoc" id="btnSupportingDoc" class="btn btn-warning">Supporting Document</button>
			</center>
		   </div>
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">Household Member Income</h4></div>
			  <div class="panel-body">
				<div class="panel panel-info">
			    <center><label for="exampleInputName2">HOUSEHOLD NAME</label></center>
				<center><input type="text" class="form-control" id="househodName" name="househodName"  ></center>
				</div>
				
				<label for="exampleInputName2">Old Age Pension R</label>
				<input type="number" class="form-control" id="oldAgePension" name="oldAgePension" placeholder="100" >
				
				<label for="exampleInputName2">Disability Age Pension R</label>
				<input type="number" class="form-control" id="disabilityAgePension" name="disabilityAgePension" placeholder="100" >
				
				<label for="exampleInputName2">Previous Work Pension R</label>
				<input type="number" class="form-control" id="prevWorkPension" name="prevWorkPension" placeholder="100" >
				
				<label for="exampleInputName2">Home Business Income R</label>
				<input type="number" class="form-control" id="homeBusIncome" name="homeBusIncome" placeholder="100" >
				
				<label for="exampleInputName2">UIF R</label>
				<input type="number" class="form-control" id="UIF" name="UIF" placeholder="100" >
				
				<label for="exampleInputName2">Other Expenses R</label>
				<input type="number" class="form-control" id="otherExp" name="otherExp" placeholder="100" >
				...
				<table>
					<tr>
					<td>
					<center><button type="submit" name="btnBack"  id="btnBack" class="btn btn-primary btn-lg active"><< Back</button></center>
					</td>
					<td>
					...
					<td>
					<center><button type="submit" name="btnCancel"  id="btnCancel" class="btn btn-danger btn-lg active">Cancel</button></center>
					</td>
					</tr>
