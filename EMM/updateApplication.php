        ...
        <div class="container">
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > 
                              ...
                              <h4 class="thin text-center">Quick Links</h4>
			  ...
			  <div class="panel-body">
                            ...
                            <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="updateApplicantInfo.php">Update Indigent Applicant Info</a>
                                </li>
                             </ul>
                             
                               <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="UpdateContactInfo.php">Update Contact Info</a>
                                </li>
                             </ul>
                              
                               <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="UpdateResidetialAddress.php">Update Residential Address Info</a>
                                </li>
                             </ul>
                            
                               <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="selectMemberToUpdate.php">Update Household member(s) Info</a>
                                </li>
                             </ul>
                               ...
                               <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="MyHouseholdBudgetInfo.php">Update Household Budget Info</a>
                                </li>
                             </ul>
                              
                               <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="UpdateMyLivingCond.php">Update Living Condition Info</a>
                                </li>
                             </ul>
                              
                               <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="UpdateSuppotingDoc.php">Update Supporting Doc </a>
                                </li>
                             </ul>
