...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if(isset($_POST["btnSubmit"]))
	{
            ...
            $databaseManager->updateLogin($_POST["id"], $_POST["password"]);
...
<head>
    ...
    <![endif]-->
    <script type="text/javascript" src="validateLoginDetails2.js"></script>
	...
	<section id="register">
        <div class="container">
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">Reset Your Password</h4></div>
			  <div class="panel-body">
				
                                <label for="exampleInputName2">ID Number/Emp Num </label> <label id="lblId"></label>
                               <input type="email" class="form-control" id="id" name="id" required readonly value="<?php print $_SESSION["resetID"] ?>" >
				
				<label for="exampleInputName2">Username </label> <label id="lblEmail"></label>
				<input type="email" class="form-control" id="username" name="username" onkeyup="validateEmail()" required readonly value="<?php print $_SESSION["email"] ?>" >
