...
if($_SERVER['REQUEST_METHOD']=='POST')
{
        if(isset($_POST["btnNext"]))
	{
            ...
            $databaseManager->updateLivingCondition($updateId,$ownerType,$typeOfHouse,$insideRoom,$outsideRoom,$cooking,$radio,$lights,$heaters,$tv,$vaccuming,$geyser,$washingMachine);
