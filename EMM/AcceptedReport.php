	...
	<section id="register">
        <div class="container">
            ...
            <div class="row">
                ...
                <article class="col-xs-12 maincontent">
                <div class="panel panel-info">
		   <div class="panel-heading" > <h4 class="thin text-center">Accepted Applicant(s)</h4></div>
                                ...
                                require_once('./PHP/dbConnect.php');
                                 ...
                                 if($_SERVER['REQUEST_METHOD']=='POST')
                                 {
                                      if(isset($_POST["btnSearch"]))
                                      {
                                          ...
                                          if(!empty($date))
                                          {
                                                $sql = "select * from tblindigentapplication,tblapplicationstatus,tblaccount where tblindigentapplication.id = tblapplicationstatus.applicantID AND tblaccount.id=tblindigentapplication.id AND status='A' ORDER BY date DESC";
