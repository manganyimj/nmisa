                                ...
                                require_once('./PHP/dbConnect.php');
                                 ...
                                 if($_SERVER['REQUEST_METHOD']=='POST')
                                 {
                                      if(isset($_POST["btnSearch"]))
                                      {
                                          ...
                                          if(!empty($date))
                                          {
                                                $sql = "select * from tblindigentapplication,tblapplicationstatus,tblaccount where tblindigentapplication.id = tblapplicationstatus.applicantID AND tblaccount.id=tblindigentapplication.id ORDER BY date DESC";
