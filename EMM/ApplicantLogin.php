 ...
 //===========================Current User======================================
    ...
    if(isset($check))
    {
            ...
            if ($result->num_rows > 0)
            {
                ...
                {
                    $fullname=$row['title']." ".$row['surname']." ".$row['name'];
                    $refNum=$row['reffNum'];
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
                            ...
                            <li class="btn btn-link">
                                <a class="btn-link" href="register.php">Apply</a>
                            </li>
                             </ul>
                              
                            <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="acknolegementMessage.php">View Acknowledgement AND Messages</a>
                                </li>
                             </ul>
                             
                               <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="applicationStatus.php">View Application Status</a>
                                </li>
                             </ul>
                              ...
                              <ul class=" btn-warning">
                                <li class="btn btn-link">
                                    <a class="btn-link" href="updateApplication.php">Update Application Infor</a>
                                </li>
                             </ul>
                             ...
                             <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                                <div class="panel panel-success">
                                               <div class="panel-heading" > 
                                                   ...
                                                   <h4 class="thin text-center">Ref Num: '.$refNum.'</h4>
