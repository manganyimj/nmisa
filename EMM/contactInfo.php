...
$residentiaAddressl = unserialize($_SESSION['residentiaAddressl']);
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	else if(isset($_POST["btnNext"]))
	{
            ...
            $contact=new Contact($_POST['cellNum'], $_POST['homeTell'], $_POST['workTell'],  $_POST['email']);
            $_SESSION['contact'] = serialize($contact);
            $databaseManager=new DatabaseManager();
            $databaseManager->Apply($indigentApplication,$residentiaAddressl,$contact,$account);
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
				...
				<label for="exampleInputName2">Cell No</label> <label id="lblCell"></label>
                                <input type="number" class="form-control" id="cellNum" name="cellNum" required onkeyup="validatePhone()" placeholder="0729255678" >
				
				<label for="exampleInputName2">Home Tell No</label><label id="lblTell"></label>
                                <input type="number" class="form-control" id="homeTell" name="homeTell"  onkeyup="validateHomeTel()"placeholder="01234567890" >
				
				<label for="exampleInputName2">Work Tell No</label><label id="lblworkTell"></label>
                                <input type="number" class="form-control" id="workTell" name="workTell"  onkeyup="validateWorkTel()"placeholder="01234567890" >
				
				<label for="exampleInputName2">Email Address</label><label id="lblEmail"></label>
                                <input type="email" class="form-control" id="email" name="email" required onkeyup="validateEmail()" placeholder="john@gmail.com" " >
