            ...
            <article class="col-xs-12 maincontent">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading" > <h4 class="thin text-center">Select Report Type</h4></div>
                                <div class="panel-body">
                                     <ul class=" btn-warning">
                                    <li class="btn btn-link">
                                        <a class="btn-link" href="AcceptedReport.php">View Accepted Applicants(s)</a>
                                    </li>
                                     </ul>
                                    
                                    <ul class=" btn-warning">
                                    <li class="btn btn-link">
                                        <a class="btn-link" href="RejectReport.php">View Rejected Applications</a>
                                    </li>
                                     </ul>
                                    
                                     <ul class=" btn-warning">
                                    <li class="btn btn-link">
                                        <a class="btn-link" href="LivingStatisticRep.php">View Living condition Statistic</a>
                                    </li>
                                     </ul>
                                    
                                    <ul class=" btn-warning">
                                    <li class="btn btn-link">
                                        <a class="btn-link" href="AllApplicantsReport.php">View All Applicants</a>
                                    </li>
                                     </ul>
                                    ...
                                    <br>
                                      <center>
                                          <a class="page-scroll" href="AssessmentCommitteeLogin.php">Back to Main Page?</a>
                                    </center>
                                </div>
                    </div>
