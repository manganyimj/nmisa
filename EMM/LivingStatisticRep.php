	...
	<section id="register">
        <div class="container">
            ...
            <div class="row">
                ...
                <article class="col-xs-12 maincontent">
                <div class="panel panel-info">
		   <div class="panel-heading" > <h4 class="thin text-center">Number of people who have Access to the following Items</h4></div>
			  <div class="panel-body">
                                  ...
                                  $total=0;
                                   require_once('./PHP/dbConnect.php');
                                    $sql = "select * from tbllivingcondition";
                                    ...
                                    /*$WashingMachine=($WashingMachine/$total)*100;
                                    $Geyser=($Geyser/$total)*100;
                                    $Vaccuming=($Vaccuming/$total)*100;
                                    $TV=($TV/$total)*100;
                                    $Heaters=($Heaters/$total)*100;
                                    $Lights=($Lights/$total)*100;
                                    $Radio=($Radio/$total)*100;
                                    $Cooking=($Cooking/$total)*100;*/
                            ...
                            ?>
                              ...
                              <table class="table table-bordered small ">
                                ...
                                <td><b><?php echo $WashingMachine;?></b></td>
                                </tr>
                                
                                <tr>
                                <td><b>Geyser</b></td>
                                <td><b><?php echo $Geyser;?> </b></td>
                                </tr>
                                
                                <tr>
                                <td><b>Vaccuming</b></td>
                                <td><b><?php echo $Vaccuming;?> </b></td>
                                </tr>
                                
                                <tr>
                                <td><b>TV</b></td>
                                <td><b><?php echo $TV;?> </b></td>
                                </tr>
                                
                                <tr>
                                <td><b>Heaters</b></td>
                                <td><b><?php echo $Heaters;?> </b></td>
                                </tr>
                                
                                <tr>
                                <td><b>Lights</b></td>
                                <td><b><?php echo $Lights;?> </b></td>
                                </tr>
                                
                                <tr>
                                <td><b>Radio</b></td>
                                <td><b><?php echo $Radio;?></b></td>
                                <tr/>
