	...
	<section id="register">
        <div class="container">
            ...
            <div class="row">
                ...
                <article class="col-xs-12 maincontent">
                <div class="panel panel-info">
		   <div class="panel-heading" > <h4 class="thin text-center">Acknolegement And Message</h4></div>
			  <div class="panel-body">
                          ...
                          <form action="pdf.php" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                                <div class="panel panel-info">
                                    <div class="panel-heading" > <h4 class="thin text-center"> Acknolegement </h4></div>
                                        <div class="panel-body">
                                              <?php
                                              $found=false;
                                                ...
                                                //$id='9304246082082';
                                                $sql = "select * from acknowledgement,tblaccount where tblaccount.id= acknowledgement.id  AND acknowledgement.id ='$id'";
                                                               ...
                                                               while($row = $result->fetch_assoc()) 
                                                                {
                                                                   $mssg=$row["mssg"];
                                                                   $ref=$row["reffNum"];
                                                                   echo "<center><P id=mssg name=mssg style=color:green>".$row["mssg"]."</p></center>";
                                                                   echo '<hr>';
                                                                }
                                                ...
                                                echo " <input type=hidden class=form-control id=mssg   name=mssg value= '$mssg'>";
                                                echo " <input type=hidden class=form-control id=refNo   name=refNo value= '$ref'>";
                                               if($found==true)
                                               //if(true)
                                               {
                                                   echo ' <center><button type="submit" name="btnPrintAck"  id="btnPrintAck" class="btn btn-primary btn-lg active small">Print</button></center>';
                                               }
                                               else
                                               {
                                                   $mssg= 'No acknolegement message(s) available';
                                                   echo "<center><P style=color:orange>".$mssg."</p></center>";
                                               }
                            ...
                            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                                <div class="panel panel-info">
                                    <div class="panel-heading" > <h4 class="thin text-center"> Messages(s) </h4></div>
                                        <div class="panel-body">
                                              <?php
                                              $found=false;
                                                ...
                                                //$sql = "select * from tblmessage where id ='$id'";
                                                 $sql = "select * from tblmessage,tblaccount where tblaccount.id= tblmessage.id  AND tblmessage.id ='$id'";
                                                               ...
                                                               while($row = $result->fetch_assoc()) 
                                                                {
                                                                   $mssg=$row["mssg"];
                                                                   $ref=$row["reffNum"];
                                                                   echo "<center><P style=color:green>".$row["mssg"]."</p></center>";
                                                                   echo '<hr>';
                                                                }
                                               ...
                                               if($found==true)
                                               {
                                                   echo ' <center><button type="submit" name="btnPrintMssg"  id="btnPrintMssg" class="btn btn-primary btn-lg active small">Print</button></center>';
                                               }
                                               else
                                               {
                                                    $mssg="No message(s) available";
                                                    echo "<center><P style=color:orange>".$mssg."</p></center>";
                                               }
                                  ...
                                  <center>
                                      <a class="page-scroll" href="ApplicantLogin.php">Back to Main Page?</a>
                                 </center>
                            </div>
                            </article>
                                </form>
