...
<form name="form3" action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="POST" onsubmit="return validateForm()">
	<section id="register">
        <div class="container">
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">Message</h4></div>
			  <div class="panel-body">
			
                            <?php
					
                            if(isset($_SESSION["adminMssg"]))
                            {
                                echo "<center><P style=color:orange>".$_SESSION["adminMssg"]."</p></center><hr>";
