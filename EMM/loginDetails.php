...
<head>
    ...
    <![endif]-->
    <script type="text/javascript" src="validateLoginDetails.js"></script>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="page-scroll" href="Logout.php">Login</a>
                    </li>
                     <li>
	...
	<section id="register">
        <div class="container">
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">Login Details</h4></div>
