	...
	if(isset($_POST["btnUpdate"]))
        {
            ...
            if(!empty($_POST["updateId"]))
            {
                ...
                {
                    $sql = "UPDATE tbllogin SET status ='Active'"
                    . "WHERE id ='$selected'";
		 
                    if ($con->query($sql) === TRUE) 
                    {
                        $_SESSION["updateMssg"]="All selected users are activeted...!!";
                    }
            ...
            {
                  $_SESSION["updateMssg"]="Select user to activate...!!";
            }
	...
	<section id="register">
        <div class="container">
            ...
            <div class="row">
                ...
                <article class="col-xs-12 maincontent">
                <div class="panel panel-info">
		   <div class="panel-heading" > <h4 class="thin text-center">List Of User(s) to Activate</h4></div>
			  <div class="panel-body">
                             ...
                             <?php
                                ...
                                $sql = "select * from tblindigentapplication,tblcontact,residentialaddress,tbllogin where "
                                        . "tblindigentapplication.id = tblcontact.id and "
                                        . "tblindigentapplication.id = residentialaddress.id and "
                                        . "tblindigentapplication.id = residentialaddress.id and "
                                        . "tblindigentapplication.id = tbllogin.id and "
                                        . "residentialaddress.id and tbllogin.id=tblcontact.id  and tbllogin.status='NoActive'";
                                    ...
                                    if ($result->num_rows > 0)
                                    {
                                        ...
                                        while($row = $result->fetch_assoc()) 
                                        {
                                            echo '<tr>
                                                ...
                                                <td>'.$row["POB_Num"].'</td>
                                                <td>'.$row["cellNo"].'</td>
                                                <td><input type="checkbox" name="updateId[]" id="updateId" value="'.$row["id"].'"></a></td>
                                           </tr>';
                                ...
                                if($found==false)
                                {
                                    echo "<center><P style=color:orange>No new user to activate found...!!</p></center>";
                                }
                            ?>
                              ...
                              <?php
                                 ...
                                 if($found==true)
                                {
                                    echo ' <center><button type="submit" name="btnUpdate"  id="btnUpdate" class="btn btn-primary btn-lg active small">Update</button></center>';
                                }
