...
if($_SERVER['REQUEST_METHOD']=='POST')
{
        ...
        if(isset($_POST["btnAdd"]))
        {
            ...
            $role=$_POST["role"];
            $employeer=new Employee("", $_POST["name"], $_POST["surname"], $_POST["gander"], $_POST["phone"], $_POST["email"]);
            
            $databaseManager=new DatabaseManager();
            
            $databaseManager->addEmp($employeer, $role);
...
<head>
    ...
    <![endif]-->
    <script type="text/javascript" src="validateAddEmp.js"></script>
...
<form name="form3" action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="POST" onsubmit="return validateForm()">
	<section id="register">
        <div class="container">
                    ...
                    <div class="panel panel-info">
                         <center>
                              <?php
                                ...
                                if(isset($_SESSION["addEmpMssg"]))
                                {
                                    echo "<center><P style=color:orange>".$_SESSION["addEmpMssg"]."</p></center>";
                                }
			...
			<div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">Please Provide Employee  details</h4></div>
			  <div class="panel-body">
                              <label for="exampleInputName2">Name</label> <label id="lblName"></label>
                              <input type="text" class="form-control" id="name" required onkeyup="validateName()"name="name" placeholder="john">
				
                              <label for="exampleInputName2">Surname</label> <label id="lblSurname"></label>
				
                              <input type="text" class="form-control" id="surname" required onkeyup="validateSurname()" name="surname" placeholder="john">
				...
				<label for="exampleInputName2">Phone number</label>  <label id="lblCell"></label>
                                <input type="number" class="form-control" id="phone" required onkeyup="validatePhone()"name="phone" placeholder="0729266565" >
				
                                <label for="exampleInputName2">Email</label>  <label required id="lblEmail"></label>
				<input type="email" class="form-control" id="email"  onkeyup="validateEmail()" name="email" placeholder="john@gmail.come" >
                                
                                <label for="exampleInputName2">Emp Role</label> <label id="lblrole"></label>
				<select name="role"  class="form-control" id="role">
				 <option >Select</option>
				  <option >Indigent Clerk </option>
				  <option>Indigent Field Worker</option>
                                  <option>Indigent Assessment Committee </option> 
                                  <option >Admin</option>
				  
				</select>
				<br>
				<center><button type="submit" name="btnAdd"  id="btnAdd" class="btn btn-primary btn-lg active">Add Employee</button></center>
			</div>
                          
                            <center>
                                <a class="page-scroll" href="AdminLogin.php">Back to Main Page?</a>
                           </center>
			</div>
			</div>
			</article>
