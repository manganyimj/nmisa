...
if(!isset($check))
{
    $_SESSION["updateMssg"]="No supporting documents found...!!";
				  ...
				  <div class="panel-heading" > <center><b>DOCUMENT(S)</b></center></h1></div>
					<div class="panel-body">
						...
						?>
                                ...
                                <form action="PHP/UpdateDocs.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                 
                                  
				
                                <div class="panel panel-info">
				<div class="panel-heading" ><h4> <center><b>Add Document</b></center></h4></div>
                                <div class="panel-body">
