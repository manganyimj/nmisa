...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if(isset($_POST["btnSearch"]))
	{
            ...
            require_once './PHP/dbConnect.php';;
            $accNum=$_POST["accNum"];
            $sql= "SELECT * FROM tblaccount where accNum='$accNum' OR reffNum='$accNum'";
            ...
            {
               $_SESSION["cleckMssg"]="No applicant details found for account/ref number :".$accNum." Please provide registered account/ref number"; 
			  ...
			  <div class="panel-heading" > <h4 class="thin text-center">Search</h4></div>
					...
					<center><button type="submit" name="btnSearch"  id="btnSearch" >View Applicant details</button></center>
                            ...
                            <li class="btn btn-link">
                                <a class="btn-link" href="ViewApplicants.php"> View All applicants</a>
                            </li>
                             </ul>
