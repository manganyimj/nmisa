...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	else if(isset($_POST["btnNext"]))
	{
            ...
            $databaseManager->addLivingCondition($id,$ownerType,$typeOfHouse,$insideRoom,$outsideRoom,$cooking,$radio,$lights,$heaters,$tv,$vaccuming,$geyser,$washingMachine);
	...
	<section id="register">
        <div class="container">
			...
			<center>
				...
				<button disabled type="submit" name="livingCond" id="livingCond" class="btn btn-info">Living Condition</button>
