...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	if(isset($_POST["btnlogin"]))
	{
            ...
            $databaseManager->checklogin($username, $id);
        ...
        <div class="container">
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
				...
				<label for="exampleInputName2">ID/Emp Number</label>
				<input type="text" class="form-control" id="id" name="id" placeholder="9304246787987 OR 742FW6338" >
