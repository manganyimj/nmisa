	...
	else if(isset($_POST["btnCancel"]))
	{
        ...
        else if(isset($_POST["btnAdd"]))
        {
            if(isset($_POST["updateId"]))
            {
               ...
               header('location:AddHouseholdBudget.php');
              
            }
            else
            {
                $_SESSION["selectMssg"]="Please Select Row to update..!!";
        ...
        else if(isset($_POST["btnAdd"]))
        {
            ...
            else
            {
                ...
                $householdMember=new HouseholdMember($_POST['id'], $_POST['indigentType'], $_POST['surname'], $_POST['init'], $_POST['DOB'], $_POST['status'],
                        $_POST['employee'], $_POST['education'],$_POST['monIncome'], $_POST['disability'], $_POST['disabilityDesc']);
	...
	<section id="register">
        <div class="container">
			...
			<center>
                ...
                <article class="col-xs-12 maincontent">
                    ...
                    <div class="panel panel-info">
                        <?php
                                ...
                                if(isset($_SESSION["selectMssg"]))
                                {
                                    echo "<center><P style=color:orange>".$_SESSION["selectMssg"]."</p></center>";
                                }
                ...
                <article class="col-xs-12 maincontent">
                <div class="panel panel-info">
		   <div class="panel-heading" > <h4 class="thin text-center">Select Household Member to add Budget</h4></div>
                              ...
                              <?php
                                ...
                                if($noMembers)
                                {
                                    echo '<article class="col-xs-12 maincontent">
                                        ...
                                        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                                            <div class="panel panel-info">
                                                <div class="panel-heading" > <h4 class="thin text-center">Proceed</h4></div>
                                                    <div class="panel-body">
                                                      <center><P style=color:orange>You have entered all household member(s) budget.Click next to proceed...!!</p></center>
                                                      <center><button type="submit" name="btnNext"  id="btnNext" class="btn btn-primary btn-lg active small">Next</button></center>
                                ...
                                {
                                    echo ' <center><button type="submit" name="btnAdd"  id="btnAdd" class="btn btn-primary btn-lg active small">Add budget</button></center>';
                                }
