...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	if(isset($_POST["btnSubmit"]))
	{
           ...
           $databaseManager->updateHouseholdBudget2($householdbudget,$updateId);
        ...
        <div class="container">
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
                                ...
                                <label for="exampleInputName2">Monthly Income R</label>
                                <input type="number" class="form-control" id="monIncome" name="monIncome"  required value="<?php print $monthlyIncome; ?>"  >
				
				<label for="exampleInputName2">Bond Payment R</label>
                                <input type="number" class="form-control" id="bondPay" name="bondPay" <?php print $readonly?>  required value="<?php print $bondPayment; ?>"  >
				
				<label for="exampleInputName2">Rental R</label>
				<input type="number" class="form-control" id="rental" name="rental" <?php print $readonly?>  required value="<?php print $rental; ?>"  >
				
				<label for="exampleInputName2">Electricity R</label>
				<input type="number" class="form-control" id="electricity" name="electricity" <?php print $readonly?>  required value="<?php print $electricity; ?>"  >
				
				<label for="exampleInputName2">Water R</label>
				<input type="number" class="form-control" id="water" name="water" <?php print $readonly?>  required value="<?php print $water; ?>"  >
				
				<label for="exampleInputName2">Food R</label>
				<input type="number" class="form-control" id="food" name="food" <?php print $readonly?>  required value="<?php print $food; ?>" >
				
				<label for="exampleInputName2">Transport R</label>
				<input type="number" class="form-control" id="transport" name="transport" required value="<?php print $transport; ?>" >
				
				<label for="exampleInputName2">Education R</label>
				<input type="number" class="form-control" id="education" name="education" required value="<?php print $education; ?>">
			
				<label for="exampleInputName2">Medical Expenses R</label>
				<input type="number" class="form-control" id="medExp" name="medExp" required value="<?php print $medicalExpense; ?>"  >
				
				
				<label for="exampleInputName2">Other Expenses R</label>
				<input type="number" class="form-control" id="otherExp" name="otherExp" required value="<?php print $otherExpenses; ?>" >
