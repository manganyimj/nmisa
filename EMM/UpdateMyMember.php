	...
	if(isset($_POST["btnUpdate"]))
        {
             ...
             include './PHP/DatabaseManager.php';
               ...
               //$databaseManager->updateHouseholdMemberByApplicant($householdMember);
            ...
            if ($con->query($sql) === TRUE) 
            {
                ...
                $_SESSION["myHouseholdMssg"]="Member Successfully Updated";
                header('location:SelectMemberToUpdate.php'); 
            } 
            else
            {
                $_SESSION["myHouseholdMssg"]="Error household member not updated: " . $con->error;
                header('location:SelectMemberToUpdate.php');
