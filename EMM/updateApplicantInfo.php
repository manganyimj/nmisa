			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
				...
				<label for="exampleInputName2">Surname </label><label id="lblSurname"></label>
                                <input type="text" class="form-control" id="surname" onkeyup="validateSurname()"  value="<?php print $surname; ?>" required name="surname" placeholder="Jane Doe" >
				
				<label for="exampleInputName2">Name </label> <label id="lblName"></label>
				<input type="text" class="form-control" id="name" name="name"  onkeyup="validateName()"  value="<?php print $name; ?>" required placeholder="Jane Doe" >
				...
				<select name="gander"  class="form-control" id="gander">
                                  <option > <?php print $gander; ?></option>
				  <option>Male</option>
				...
				<select name="status"  class="form-control" id="status">
                                  <option ><?php print $maritalStatus; ?></option>
				...
				<select name="appType"  class="form-control" id="appType">
                                  <option > <?php print $applicationType; ?></option>
