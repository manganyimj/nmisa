...
$databaseManager->getHouseholdMember($updateId);

 $id=$_SESSION["id"];
 $IndigentType=$_SESSION["IndigentType"];
 $surname=$_SESSION["surname"];
 $initials=$_SESSION["initials"];
 $DOB=$_SESSION["DOB"];
 $applicationStatus=$_SESSION["applicationStatus"];
 $employeer=$_SESSION["employeer"];
 $education=$_SESSION["education"];
 $monthlyIncome=$_SESSION["monthlyIncome"];
 $disability=$_SESSION["disability"];
 $disabilityDescriptiong=$_SESSION["disabilityDescriptiong"];
 $addedByID=$_SESSION["addedByID"];
        ...
        else if(isset($_POST["btnUpdate"]))
        {
             ...
             include './PHP/HouseholdMember.php';
                $householdMember=new HouseholdMember($_POST['id'], $_POST['indigentType'], $_POST['surname'], $_POST['init'], $_POST['DOB'], $_POST['status'],
                        $_POST['employer'], $_POST['education'],$_POST['monIncome'], $_POST['disability'], $_POST['disabilityDesc']);
        
               
                $databaseManager->updateHouseholdMember($householdMember, $indigentApplication);
	...
	<section id="register">
        <div class="container">
			...
			<center>
				...
				<button type="submit" name="btnHouseMember" id="btnHouseMember" class="btn btn-info">Household Members</button>
				<button type="submit" name="btnHouseBudget" id="btnHouseBudget" class="btn btn-warning">Household Budget</button>
                    ...
                    <div class="panel panel-info">
                         <center>
                              <?php
                                ...
                                if(isset($_SESSION["updateMssg"]))
                                {
                                    echo "<center><P style=color:orange>".$_SESSION["updateMssg"]."</p></center>";
                                }
			...
			<div class="panel panel-info">
			  ...
			  <label for="exampleInputName2">RSA ID Number</label>
				<input type="number" class="form-control" id="id" name="id" value="<?php print $id; ?>" placeholder="9004846062082">
			...
			<label for="exampleInputName2">Indigent Type</label>
				...
				<label for="exampleInputName2">Monthly Income</label>
				<input type="number" class="form-control" id="monIncome" value="<?php print $monthlyIncome; ?>"  name="monIncome" placeholder="1000"  >
				...
				<table>
					...
					<td>
					<center><button type="submit" name="btnBack"  id="btnBack" class="btn btn-warning btn-lg active">Back</button></center>
					</td>
