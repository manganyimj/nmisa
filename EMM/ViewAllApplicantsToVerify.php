...
if($_SERVER['REQUEST_METHOD']=='POST')
{
        ...
        if(isset($_POST["btnView"]))
        {
            ...
            {
                $_SESSION["viewMssgApp"]="Please Select Row to view..!!";
                    ...
                    <div class="panel panel-info">
                         <center>
                              <?php
                                ...
                                if(isset($_SESSION["viewMssgApp"]))
                                {
                                    echo "<center><P style=color:orange>".$_SESSION["viewMssgApp"]."</p></center>";
                                }
		   ...
		   <div class="panel-heading" > <h4 class="thin text-center">New Applicant(s)</h4></div>
			  <div class="panel-body">
                             ...
                             <?php
                                ...
                                $sql = "select * from tblindigentapplication,tblapplicationstatus where tblindigentapplication.id = tblapplicationstatus.applicantID AND status='VerificationInProgress' ORDER BY date DESC";
                            ...
                            ?>
                              ...
                              if($availableusers==true)
                              {
                                  echo '<center> <table>
                                        ...
                                        <tr>
                                            <td><button type="submit" name="btnView"  id="btnView" class="btn btn-primary btn-lg active small">Verify details</button></td>
