	...
	<section id="register">
        <div class="container">
            ...
            <div class="row">
                ...
                <article class="col-xs-12 maincontent">
                <div class="panel panel-info">
		   <div class="panel-heading" > <h4 class="thin text-center">Rejected Applicant(s)</h4></div>
			  <div class="panel-body">
                              ...
                              <table>
                                  ...
                                  <tr>
                                      <td bgcolor="#00FFFF"><label for="exampleInputName2">Search By:</label> </td><td bgcolor="#00FFFF"><input type="date" class="form-control" id="date" name="date" ></td> <td bgcolor="#00FFFF"><center><button type="submit" name="btnSearch"  id="btnSearch" >Search</button></center></td>
                                     
                                        <td  bgcolor="#00FFFF"><button type="submit" name="btnAll"  id="btnAll" >View All</button></td>
                                  </tr>
                              ...
                              <table class="table table-bordered small ">
                                ...
                                <td><b>Surname</b></td>
                                <td><b>Name</b></td>
                                <td><b>Application Date And Time</b></td>
                                <td><b>Reason Of Rejection</b></td>
                                ...
                                require_once('./PHP/dbConnect.php');
                                 ...
                                 if($_SERVER['REQUEST_METHOD']=='POST')
                                 {
                                      if(isset($_POST["btnSearch"]))
                                      {
                                          ...
                                          if(!empty($date))
                                          {
                                                $sql = "select * from tblindigentapplication,tblapplicationstatus,acknowledgement where tblindigentapplication.id = tblapplicationstatus.applicantID AND acknowledgement.id=tblindigentapplication.id AND status='D' ORDER BY date DESC";
                            ...
                            ?>
                              ...
                              {
                                  echo "<center><P style=color:orange>No Appicant(s) Available..!!</p></center>";
                              }
                              ...
                              <center>
                                  <a class="page-scroll" href="Reports.php">Back to Main Page?</a>
                                     </center>
                         </div>
                </div>
                </article>
