...
$householdbudget = unserialize($_SESSION['householdbudget']);
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	else if(isset($_POST["btnSubmit"]))
	{
           ...
           $householdbudget2=new HouseholdBurdget($_POST['bondPay'], $_POST['rental'], $_POST['electricity'], $_POST['water'], $_POST['food'], $_POST['transport'], $_POST['education'], $_POST['medExp'], $_POST['otherExp'],$_POST['monIncome']);
           $databaseManager->updateHouseholdBudget($householdbudget2,$updateId);
           
         
           
           //header('location:HouseholdBudgetInfo.php');	
	}
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
				...
				<label for="exampleInputName2">Bond Payment R</label>
                                <input type="number" class="form-control" id="bondPay" name="bondPay" required readonly value="<?php print $bondPayment; ?>"  >
				
				<label for="exampleInputName2">Rental R</label>
                                <input type="number" class="form-control" id="rental" name="rental" required readonly value="<?php print $rental; ?>"  >
				
				<label for="exampleInputName2">Electricity R</label>
				<input type="number" class="form-control" id="electricity" name="electricity" readonly required value="<?php print $electricity; ?>"  >
				
				<label for="exampleInputName2">Water R</label>
				<input type="number" class="form-control" id="water" name="water" required readonly value="<?php print $water; ?>"  >
				
				<label for="exampleInputName2">Food R</label>
				<input type="number" class="form-control" id="food" name="food" required readonly value="<?php print $food; ?>" >
