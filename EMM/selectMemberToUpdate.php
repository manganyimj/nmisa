...
if(!isset($check))
{
    $_SESSION["updateMssg"]="You dont have any household member to update ";
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
        if(isset($_POST["btnUpdatMember"]))
        {
            ...
            if(isset($_POST["updateId"]))
            {
               ...
               header('location:UpdateMyMember.php');

            }
            else
            {
                $_SESSION["myHouseholdMssg"]="please Select Row to update..!!";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="panel panel-info">
                    <?php echo " <div class=panel-heading ><center> <h4 class=thin text-center>Select Member </h4></center></div>";?>
                             ...
                             <center> 
                               ...
                               <center>   
                                     <?php
                                        ...
                                        if(isset($_SESSION["myHouseholdMssg"]))
                                        {
                                            echo "<center><P style=color:orange>".$_SESSION["myHouseholdMssg"]."</p></center>";
                                        }
