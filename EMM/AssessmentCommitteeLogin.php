...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if(isset($_POST["btnSearch"]))
	{
            ...
            $accNum=$_POST["accNum"];
            $status="Verified";
            $sql= "SELECT * FROM tblaccount,tblapplicationstatus where tblaccount.id=tblapplicationstatus.applicantID AND status='$status'  AND id='$accNum' OR reffNum='$accNum' ";//tblapplicationstatus.status='.$status.' 
            ...
            {
               $_SESSION["signInMssg"]="The applicant that you are searching is either he/she  have not applied or his/her information have not been verified yet OR you have verified his/her application"; 
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
		  ...
		  <div>
                    ...
                    <?php  echo "<center><P style=color:white><b>Welcome ".$fullname."</b></p></center>" ;?> 
        ...
        <div class="container">
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
                           ...
                           <div class="panel panel-info">
			  <div class="panel-heading" > <h4 class="thin text-center">Search</h4></div>
                          <div class="panel-body">
                             
                              <input type="search" class="form-control" id="accNum" name="accNum" onkeyup="validateSearch()" required placeholder="Enter Account number or Ref number" >
                              <br>
                              <center>
                              <table>
                                <tr>
                                  <td>
					<center><button type="submit" name="btnSearch"  id="btnSearch" >View Applicant details</button></center>
				  </td>
                            ...
                            <li class="btn btn-link">
                                <a class="btn-link" href="ViewAllApplicantToAssess.php"> View All applicants</a>
                            </li>
                             </ul>
                             ...
                             <ul class=" btn-warning">
                              ...
                              <ul class=" btn-warning">
                            <li class="btn btn-link">
                                <a class="btn-link" href="Reports.php">View Reports</a>
                            </li>
                            </ul>
