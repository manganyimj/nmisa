...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if(isset($_POST["btnSubmit"]))
	{
            ...
            if($isRegistered)
            {
                ...
                $sql="UPDATE tbllogin SET password='$password',status='$status'  Where id='$id'";
                if($con->query($sql))
                {
                    $_SESSION["adminMssg"]="User login details have been reseted...!!";
                    header('location:AdminFeedback.php');
                    
                    //===============Send Email=================================
                    $to = $email;
                    $subject ="EMM";
                    $message = "Your Login details have been updated, NOTE: your new password is:".$phone." And your username is :".$email;
                    $headers = 'From: EMM' . "\r\n" .
                                            'Reply-To: emm.co.za' . "\r\n" .
                                            'Hi' ;
            ...
            {
               $_SESSION["adminMssg"]="No user found for user ID/Emp number :".$id; 
                //header('location:AdminFeedback.php');
            }
        ...
        <div class="container">
			...
			<div class="panel panel-info">
			  ...
			  <div class="panel-body">
				...
				<label for="exampleInputName2">Enter User ID No or Emp No</label> <label id="lblEmail"></label>
                                <input type="text" class="form-control" id="id" name="id" onkeyup="validateEmail()" required >
				...
				<table>
					...
					<td>
					<center><button type="submit" name="btnSubmit"  id="btnSubmit" class="btn btn-primary btn-lg active">Reset</button></center>
					</td>
