            ...
            <div class="col-md-12 col-md-offset-0">
                <div class="panel panel-warning" style="box-shadow: 2px 2px 2px 2px #2d2c2b;">
                    <div class="panel-heading" style="box-shadow: 2px 2px 2px 2px #2d2c2b;">
                        <h2 style="text-shadow: 2px 2px 4px black;" align="center">Careers at RonRof Global Freight</h2></div>
                        <div class="panel-body">
                        <div class="container">
						   <div class="panel-body">
						    <center><p> We offer a wide range of rewarding career opportunities in various areas such as</p>
							<p>but not limited to, logistics, transportation, warehousing, </p>
							<p>dedicated distribution and various support functions.</p>
							<p>Our <span style="color:red">Mission</span> is to continuously develop and implement strategies,</p>
							<p>and programs that will ensure success in road transport and logistics services.</p></center>
							
							 </br></br>
							 <h2><center> Email us your CV  to RonRof Global Freight email address(careers@ronrofglobalfreight.co.za)<center></h2>
						  </div>
                        </div>
